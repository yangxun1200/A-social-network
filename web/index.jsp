...
<html>
    ...
    <body>
        ...
        <p>1111111111111111111This simple app is for people who like playing basketball and they can add friends with each other (By sending request and give response)
